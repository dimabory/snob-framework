...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    {
        // make sure we'ru_RU dealing with an array
...
// Check if we'ru_RU running on windows
Smarty::$_IS_WINDOWS = strtoupper(substr(PHP_OS, 0, 3)) === 'WIN';

// let PCRE (preg_*) treat strings as ISO-8859-1 if we'ru_RU not dealing with UTF-8
